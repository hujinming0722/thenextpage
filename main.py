...
import psutil
from buttonfuncs import UpDownWindow,penWindow


class PPTController:
    def __init__(self, app: QApplication):
        self.app = app
        self.left_window: Optional[UpDownWindow] = None
        self.right_window: Optional[UpDownWindow] = None
